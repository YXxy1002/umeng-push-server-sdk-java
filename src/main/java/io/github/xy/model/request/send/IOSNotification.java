...
public abstract class IOSNotification extends UmengNotification {
    ...
    protected static final HashSet<String> APS_KEYS = new HashSet<>(Arrays.asList("alert", "badge", "sound", "content-available", "threadIdentifier"));
    ...
    public boolean setPredefinedKeyValue(String key, Object value) throws Exception {
        if (ROOT_KEYS.contains(key)) {
            ...
            if (Arrays.asList("payload", "aps", "policy").contains(key)) {
    ...
    public void setThreadIdentifier(String uuid) throws Exception {
        setPredefinedKeyValue("threadIdentifier", uuid);
    }
}
